...
function kurzusLetrehozas() {
  ...
  inputDepartment.id = "inputDepartment";
  inputDepartment.className = "formTexts";
  inputDepartment.placeholder = "Tanszék";
  ...
  submitButton.addEventListener('click', async () => {
    ...
    var credit = document.getElementById("inputCredit").value;
