        ...
        public async Task Init()
        {
            ...
            if (!context.Users.Any())
            {
                List<User> users = new List<User>
                {
                    ...
                    new User { Id = 4, UserName = "URK2SP", Name = "Kovács Bence", Password = "ucw803", Degree_Id = 6, Role = "diák"},
                    new User { Id = 5, UserName = "A9T32P", Name = "Bálint Miklós", Password = "nagyafaszom", Degree_Id = 3, Role = "diák"},
                    new User { Id = 6, UserName = "FAR0K5", Name = "Péter Árpád", Password = "titkos01", Degree_Id = 7, Role = "diák"},
                    new User { Id = 7, UserName = "XG739D", Name = "Minta Béla", Password = "mintajel", Degree_Id = 8, Role = "diák"},
                    ...
                    new User { Id = 11, UserName = "AR4K1S", Name = "Paul Atreides", Password = "LisanAlGaib", Degree_Id = 9, Role = "diák"},
            ...
            if (!context.MyCourses.Any())
            {
                List<MyCourse> myCourses = new List<MyCourse>
                {
                    ...
                    new MyCourse { Id = 22, User_Id = 4, Course_Id = 1 },
                    new MyCourse { Id = 23, User_Id = 4, Course_Id = 2 },
                    new MyCourse { Id = 24, User_Id = 4, Course_Id = 3 },
                    new MyCourse { Id = 25, User_Id = 4, Course_Id = 4 },
                    new MyCourse { Id = 26, User_Id = 4, Course_Id = 5 },
                    new MyCourse { Id = 27, User_Id = 4, Course_Id = 6 },
                    new MyCourse { Id = 28, User_Id = 4, Course_Id = 7 },
                    new MyCourse { Id = 29, User_Id = 4, Course_Id = 8 },
                    new MyCourse { Id = 30, User_Id = 4, Course_Id = 9 },
                    new MyCourse { Id = 31, User_Id = 4, Course_Id = 10 },
                    new MyCourse { Id = 32, User_Id = 4, Course_Id = 11 },
                    new MyCourse { Id = 33, User_Id = 4, Course_Id = 12 },

                    new MyCourse { Id = 34, User_Id = 6, Course_Id = 1 },
                    new MyCourse { Id = 35, User_Id = 6, Course_Id = 2 },
                    new MyCourse { Id = 36, User_Id = 6, Course_Id = 3 },
                    new MyCourse { Id = 37, User_Id = 6, Course_Id = 4 },
                    new MyCourse { Id = 38, User_Id = 6, Course_Id = 5 },
                    new MyCourse { Id = 39, User_Id = 6, Course_Id = 6 },
                    new MyCourse { Id = 40, User_Id = 6, Course_Id = 7 },
                    new MyCourse { Id = 41, User_Id = 6, Course_Id = 8 },
                    new MyCourse { Id = 42, User_Id = 6, Course_Id = 9 },
                    new MyCourse { Id = 43, User_Id = 6, Course_Id = 10 },
                    new MyCourse { Id = 44, User_Id = 6, Course_Id = 11 },
                    new MyCourse { Id = 45, User_Id = 6, Course_Id = 12 },

                    new MyCourse { Id = 46, User_Id = 7, Course_Id = 1 },
                    new MyCourse { Id = 47, User_Id = 7, Course_Id = 2 },
                    new MyCourse { Id = 48, User_Id = 7, Course_Id = 3 },
                    new MyCourse { Id = 49, User_Id = 7, Course_Id = 4 },
                    new MyCourse { Id = 50, User_Id = 7, Course_Id = 5 },
                    new MyCourse { Id = 51, User_Id = 7, Course_Id = 6 },
                    new MyCourse { Id = 52, User_Id = 7, Course_Id = 7 },
                    new MyCourse { Id = 53, User_Id = 7, Course_Id = 8 },
                    new MyCourse { Id = 54, User_Id = 7, Course_Id = 9 },
                    new MyCourse { Id = 55, User_Id = 7, Course_Id = 10 },
                    new MyCourse { Id = 56, User_Id = 7, Course_Id = 11 },
                    new MyCourse { Id = 57, User_Id = 7, Course_Id = 12 },

                    new MyCourse { Id = 58, User_Id = 11, Course_Id = 1 },
                    new MyCourse { Id = 59, User_Id = 11, Course_Id = 2 },
                    new MyCourse { Id = 60, User_Id = 11, Course_Id = 3 },
                    new MyCourse { Id = 61, User_Id = 11, Course_Id = 4 },
                    new MyCourse { Id = 62, User_Id = 11, Course_Id = 5 },
                    new MyCourse { Id = 63, User_Id = 11, Course_Id = 6 },
                    new MyCourse { Id = 64, User_Id = 11, Course_Id = 7 },
                    new MyCourse { Id = 65, User_Id = 11, Course_Id = 8 },
                    new MyCourse { Id = 66, User_Id = 11, Course_Id = 9 },
                    new MyCourse { Id = 67, User_Id = 11, Course_Id = 10 },
                    new MyCourse { Id = 68, User_Id = 11, Course_Id = 11 },
                    new MyCourse { Id = 69, User_Id = 11, Course_Id = 12 },
